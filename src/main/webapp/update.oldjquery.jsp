				...
				<!-- start form Username -->
        			<form method="GET" action="data" enctype="multipart/form-data">
            				...
            				<input type="hidden" name="action" value="connectgraph"/>
                                	...
                                	<button class="btn btn-default" type="submit" name="skip" value="false">
                                	<i class="fa fa-search fa-fw"></i>
					</button>
                                	<button class="btn btn-default" type="submit" name="skip" value="true">
                                	Next 100</button>
                            		</span>
                                       </div>
...
<!--	d3 include goes here-->
	...
	rootNodes = getNodesFromRootJson(rootFile);	
